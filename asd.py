from robot_descriptions import piper_description
...
model, collision_model, visual_model = pin.buildModelsFromUrdf(
    piper_description.URDF_PATH,
    package_dirs=[os.path.join(piper_description.REPOSITORY_PATH, "src")],
)
visualizer = PinocchioViserVisualizer(
    model=model,
    collision_model=collision_model,
    visual_model=visual_model,
)
visualizer.initViewer(open=True, loadModel=True)
